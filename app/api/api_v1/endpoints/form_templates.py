...
@router.post("", response_model=schemas.FormTemplateOut, response_model_exclude_none=True, status_code=status.HTTP_201_CREATED)
def create(
...
@router.get("/{form_template_id}", response_model=schemas.FormTemplateOut, response_model_exclude_none=True)
def get_by_id(
